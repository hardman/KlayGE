...
private:
	...
	KlayGE::TexturePtr half_res_tex_;
	KlayGE::TexturePtr half_res_min_max_ds_tex_;

	KlayGE::FrameBufferPtr quarter_res_fb_;
	KlayGE::TexturePtr quarter_res_tex_;
	KlayGE::TexturePtr quarter_res_min_max_ds_tex_;

	KlayGE::FrameBufferPtr vdm_quarter_res_fb_;
	KlayGE::TexturePtr vdm_color_tex_;
	KlayGE::TexturePtr vdm_transition_tex_;
	KlayGE::TexturePtr vdm_count_tex_;

	KlayGE::PostProcessPtr depth_to_min_max_pp_;
	KlayGE::PostProcessPtr reduce_min_max_pp_;
